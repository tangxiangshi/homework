...
Eigen::Vector3d Quaternion2Euler(Eigen::Quaterniond Q)
{
    ...
    // Implement your code here
    Euler.y() = asin(2 * (Q.w() * Q.y() - Q.x() * Q.z())); // Euler angle theta
    Euler.z() = atan2(2 * (Q.x() * Q.y() + Q.w() * Q.z()), (1 - 2 * (Q.y() * Q.y() + Q.z() * Q.z()))); // Euler angle sai
